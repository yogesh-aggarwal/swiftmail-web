import { CheckCheck, Filter, LucideStar } from "lucide-react"
...
export default function Notifications() {
   const topbar = useMemo(
      () => (
         <Topbar
            actions={[
               { name: "All", badge: "3", onClick: () => alert("Primary"), active: true },
               { name: "Unread", badge: "3", onClick: () => alert("Promotional") },
               { name: "Archived", badge: "32", onClick: () => alert("Social") },
            ]}
            search={{
         ...
         <div className="grid h-full w-[400px] grid-rows-[min-content,1fr] overflow-y-auto rounded-[1.6rem] bg-white">
            <div>
               <div className="flex h-[72px] items-center justify-between px-5">
                  <div className="text-[1.5rem] font-medium">Notifications</div>
