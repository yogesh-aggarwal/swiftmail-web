import { CheckCheck, Edit2, Filter, LucideStar, PlusCircle, RefreshCcw, Stars } from "lucide-react"
   ...
   export function Header() {
      ...
      return (
         <Topbar
            ...
            secondaryActions={[
               { name: "Ask AI", icon: <Stars size={18} />, onClick: () => alert("Ask AI") },
               { name: "New Digest", icon: <PlusCircle size={20} />, onClick: () => alert("New Digest") },
            ]}
         />
      )
   }
